...
app.get('/user-link',(req, res)=>{
    ...
    res.send('https://www.webrtc-bohd-test.site/join-video?token='+token);
...
app.get('/pro-link',(req, res)=>{
    ...
    res.send(`<a href="https://www.webrtc-bohd-test.site/dashboard?token=${token}" target="_blank">Link Here</a>`);
})